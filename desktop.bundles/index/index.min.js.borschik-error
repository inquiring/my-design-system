    ...
    onSetMod: {
        'js' : {
            'inited' : function() {
                ...
                this._current = this.findChildElem('item', 'current', true);

                console.log(this._current);
                this._domEvents('item').on('click', function(e) {
                    console.log('событие ниже');
                    console.log(($(e.currentTarget).find('e-accordion__item')));
                    this = $(e.currentTarget);
                    var elem = this._elem('item').setMod('current');
                    console.log(elem);
                    // console.log(this._elem('item').setMod('current', true));
                    // console.log(($(e.currentTarget))._elem('item').setMod('current', true));
                    // console.log(this.setMod('current', true));
                    // назначить модификатор элементу блока
                    // this.setMod(this.elem('elemName'), 'modName', 'modValue');

                    // this._elem('item').setMod('current', true);
                });
            }
        }
    },
...
provide(bemDom.declElem('e-accordion', 'short', {
    ...
    //     js: {
    //         inited: function() {
    //             block('e-accordion').elem('short').addEventListener('click', function() {
    //                 document.querySelector('.e-accordion__more').classList.toggle('e-accordion_view_hide');
    //             }, false);
    //         }
    //     }
    // }
